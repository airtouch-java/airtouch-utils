 ...
 * Is invoked when a message from the Airtouch5 has been identified as an AirConditioner error message.
 */
public class AirConditionerErrorHandler extends AbstractHandler {
    ...
    /*
        ...
        Data block received from AirTouch (variable number of bytes). See docs page 16.
